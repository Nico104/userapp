            ...
            children: [
              CustomPaint(
                painter: ConvexPainter(
                  top: drawHexagon || !convexBridge ? -38 : -21,
                  ...
                  leftCornerRadius: widget.fixed && widget.fixedIndex == 0
                      ...
                      : (widget.initialActive == 0 && !widget.fixed
                          ...
                          : widget.radius!),
                  rightCornerRadius:
                      widget.fixed && widget.fixedIndex == widget.count - 1
                          ? 0
                          : (widget.initialActive == widget.count - 1 &&
                                  !widget.fixed
                              ? 0
                              : widget.radius!),
                ),
              ...
              Padding(
                padding: EdgeInsets.only(top: widget.borderWidth),
                child: CustomPaint(
                  painter: ConvexPainter(
